...
public class SomeUtils {
    ...
    public static Long getLocalDataTimeLong() {
        return System.currentTimeMillis();
    }

    public static String getLocalDataTimeString() {
    ...
    public static String getPath() {
        return SomeUtils.class.getResource("/").getPath();
    }
    ...
    @Test
    private void DoSomeUtilsTest(){
        System.out.println(getLocalDataTimeString());
    }
